...
const PROMPTS = {
  ...
  // STEP 5 — Conferma persone + Allergie/Richieste
  step5_party_size_ask_notes: {
    ...
    largeGroupPositive:
      "Ok, {{partySize}} persone. Ci organizziamo senza problemi. C’è qualche allergia o richiesta particolare?",
    checkingAvailability:
      "Un attimo solo che controllo la disponibilità per {{partySize}} persone. Ci metto pochissimo.",
    noAvailability:
  ...
  step8_summary_confirm: {
    ...
    outdoorWeather:
      "Ti segnalo solo una cosa: il tavolo è all’esterno e il meteo è un po’ incerto. Se cambia qualcosa, ci organizziamo senza problemi.",
    kitchenNotActive:
      "A quell’orario la cucina non è attiva, però siamo aperti per bere qualcosa. Va bene lo stesso?",
    promoNotValid:
      "Ti avviso solo che a quell’orario la promo non è attiva. Il resto resta invariato.",
    tightAvailability:
